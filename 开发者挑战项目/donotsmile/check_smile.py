...
def isSmile(imgPath):
    ...
    smile = 0
    notsmile = 0
    if (y_predict_LR == "with smile"):
        smile += 1
    else:
        notsmile += 1
    if (y_predict_LSVC == "with smile"):
        smile += 1
    else:
        notsmile += 1
    if (y_predict_MLPC == "with smile"):
        ...
        notsmile += 1
    if (y_predict_SGDC == "with smile"):
        smile += 1
    else:
        notsmile += 1
    print("smile: " + str(smile) + " notsmile: " + str(notsmile) + "\n")
    if smile == 4:
        return 1
    else:
        return 0

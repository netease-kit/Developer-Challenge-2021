export default {
  ...
  menuTop: [
	...
	// 个人中心-设置中心菜单 39b54a ff4757 ff6b81
	settingList: [
		{ icon: 'iconxiaoxi3', url: '../consulation/consulation-list', title: '消息中心', color: '#39b54a' },
		{ icon: 'icongonggao', url: '/pages/mail/notice/notice', title: '商城公告', color: '#39b54a' },
		{ icon: 'iconyouhuiquan-copy', url: '/pages/user/coupon/list', title: '领券中心', color: '#39b54a' },
		{ icon: 'icondizhi1', url: '/pages/user/address/address', title: '地址管理', color: '#39b54a' },
		{ icon: 'iconshoucang3', url: '/pages/user/collection/collection', title: '我的收藏', color: '#39b54a' },
		{ icon: 'iconfenxiang', url: '', title: '分享', color: '#39b54a' },
		{ icon: 'iconzhibo', url: '/pages/marketing/live/list', title: '直播', color: '#39b54a' },
		{ icon: 'iconshezhi3', url: '/pages/set/set', title: '设置', color: '#39b54a' }
	],

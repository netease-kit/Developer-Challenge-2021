<template>
	<view class="user">
		<view>
			<nav-bar title="我的">
				<template v-slot:image>
					<navigator url="../consulation/consulation-list">
						<image src="../../static/msg.png" style="width: 40rpx;height: 40rpx;"></image>
					</navigator>
				</template>
			</nav-bar>
		</view>
		...
		<view class="user-section">
			<image class="bg" src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=191678693,2701202375&fm=26&gp=0.jpg"></image>
			<!--用户信息-->
			<view class="user-info-box">
				...
				>
					...
					<text class="username" v-else>听</text>
				</view>
			</view>
			<!--vip信息-->
		...
		>
			...
			<view class="promotion-center">
				<list-cell icon="iconwallett" iconColor="#39b54a" @eventClick="navTo('/pages/user/account/account')"
			...
			<!-- 我的订单 -->
			<view class="promotion-center">
				<list-cell icon="iconfapiaoguanli" iconColor="#39b54a"
				           @eventClick="navTo(`/pages/mail/search/search?keyword=搜索我的订单&type=order`)" title="搜索订单"></list-cell>
 ...
 -->
			<!--设置中心-->
			<view class="promotion-center">
				<list-cell icon="iconshezhi1" iconColor="#39b54a" @eventClick="navTo('/pages/set/set')"
    ...
    export default {
        ...
        data() {
            return {
                ...
                footPrintList: footPrintList, // 足迹列表
                loading: true,
		        hasLogin: false,
        ...
        onNavigationBarButtonTap(e) {
            ...
            if (index === 0) {
                ...
                // #endif
                this.$mRouter.push({route: '/pages/mail/notice/notice'});
            }
        },
        // #endif
        methods: {
            ...
            async getMemberInfo() {
				...
				/* this.loading = false;
				this.userInfo = this.memberInfo.data;
				await uni.setStorageSync('cartNum', this.memberInfo.data.cart_num);
				// 获取足迹列表
				await this.getFootPrintList();
				await this.setSectionData(this.memberInfo.data);
				await this.initCartItemCount(); */
            ...
            setSectionData(data) {
                ...
                for (let i = 0; i < this.orderSectionList.length; i++) {
                    this.orderSectionList[i].num = orderSynthesizeNumArr[i]./* toS */tring();
                }
            ...
            async getFootPrintList() {
                    ...
                    this.footPrintList = this.footPrintList.data

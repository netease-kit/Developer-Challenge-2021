...
//    public static List<TraceLocation> parseTraceLocationList(List<PathRecord> list) {
...
//            location.setLongitude(pathRecord.getLongitude());
//            location.setLatitude(pathRecord.getLatitude());
//            location.setSpeed(pathRecord.getSpeed());
//            location.setBearing(pathRecord.getBearing());
//            location.setTime(pathRecord.getTime());

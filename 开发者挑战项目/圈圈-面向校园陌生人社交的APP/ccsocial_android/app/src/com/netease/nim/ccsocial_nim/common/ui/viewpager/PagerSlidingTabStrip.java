...
package com.netease.nim.ccsocial_nim.common.ui.viewpager;
...
import com.netease.nim.ccsocial_nim.main.reminder.ReminderSettings;
...
//    private int indicatorColor = 0xFF0888ff;
    ...
    private int checkedTextColor = R.color.colorPrimaryBlue;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        checkedTextColor = a.getResourceId(R.styleable.TwoTextView_ttLeftTextColor, R.color.colorPrimaryBlue);
    ...
    public void onPageSelected(int position) {
        ...
        setChooseTabViewImageColor(position);
    }
    ...
    private void setChooseTabViewImageColor(int position){
        int childCount = tabsContainer.getChildCount();
        LinearLayout tabView;
        ImageView imageView;
        for (int i = 0; i < childCount; ++i) {
            tabView = (LinearLayout) tabsContainer.getChildAt(i);
            imageView = (ImageView) tabView.findViewById(R.id.tab_icon_label);
            if(i == position){
                switch (i){
                    case 0:
                        imageView.setImageResource(R.drawable.icon_index_show);
                        break;
                    case 1:
                        imageView.setImageResource(R.drawable.icon_contact_show);
                        break;
                    case 2:
                        imageView.setImageResource(R.drawable.icon_chat_show);
                        break;
                    case 3:
                        imageView.setImageResource(R.drawable.icon_me_show);
                        break;
                }
            }else{
                switch (i){
                    case 0:
                        imageView.setImageResource(R.drawable.icon_index_hide);
                        break;
                    case 1:
                        imageView.setImageResource(R.drawable.icon_contact_hide);
                        break;
                    case 2:
                        imageView.setImageResource(R.drawable.icon_chat_hide);
                        break;
                    case 3:
                        imageView.setImageResource(R.drawable.icon_me_hide);
                        break;
                }
            }
...
//            if (i == position) {
//                imageView.setTextColor(getResources().getColor(checkedTextColor));
//            } else {
//                textView.setTextColor(getResources().getColor(unCheckedTextColor));
//            }
        }
    ...
    private void addTabView(final int position, String title) {
        ...
        ImageView titleIMG = ((ImageView) tabView.findViewById(R.id.tab_icon_label));
        ...
        if (titleTV != null) {
            titleTV.setTextSize(TypedValue.COMPLEX_UNIT_PX, needAdaptation ? resources.getDimensionPixelSize(R.dimen.text_size_9) : resources.getDimensionPixelSize(R.dimen.text_size_10));
            titleTV.setText(title);
        }
        if (titleIMG != null) {
            switch (position){
                case 0:
                    titleIMG.setImageResource(R.drawable.icon_index_show);
                    break;
                case 1:
                    titleIMG.setImageResource(R.drawable.icon_contact_hide);
                    break;
                case 2:
                    titleIMG.setImageResource(R.drawable.icon_chat_hide);
                    break;
                case 3:
                    titleIMG.setImageResource(R.drawable.icon_me_hide);
                    break;
            }

package com.netease.nim.ccsocial_nim.redpacket;
 ...
 * 4.红包消息、拆红包消息分别使用自定义消息，参考 {@link com.netease.nim.ccsocial_nim.session.extension.RedPacketAttachment}、
 * {@link com.netease.nim.ccsocial_nim.session.extension.RedPacketOpenedAttachment},在调用金融魔方接口发送红包成功之后，发送

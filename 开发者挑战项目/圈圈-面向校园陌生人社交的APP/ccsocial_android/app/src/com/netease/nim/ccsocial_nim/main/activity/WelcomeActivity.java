...
import com.netease.nim.ccsocial_nim.common.util.sys.SysInfoUtil;
...
import com.outman.framework.view.GifView;
...
public class WelcomeActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImmersionBar.with(this)
                ...
                .navigationBarColor(R.color.colorBgGrayWhite)
                .navigationBarDarkIcon(true)
                .statusBarColor(R.color.colorBgGrayWhite)
                .init();
    ...
    private void showSplashView() {
        ...
        // 设置背景gif图片资源
        gif.setMovieResource(R.drawable.welcome);
        customSplash = true;
    }

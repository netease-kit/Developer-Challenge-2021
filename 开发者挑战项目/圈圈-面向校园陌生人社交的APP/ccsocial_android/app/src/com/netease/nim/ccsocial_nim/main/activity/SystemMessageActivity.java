package com.netease.nim.ccsocial_nim.main.activity;
...
import com.netease.nim.ccsocial_nim.main.adapter.SystemMessageAdapter;
import com.netease.nim.ccsocial_nim.main.viewholder.SystemMessageViewHolder;
...
public class SystemMessageActivity extends UI implements TAdapterDelegate,
    ...
    private void onSystemNotificationDeal(final SystemMessage message, final boolean pass) {
        ...
        switch (message.getType()) {
            ...
            case SuperTeamApply:
                ...
                break;
            case AddFriend:
                ackAddFriendRequest(fromAccount, pass);
    ...
    private void ackAddFriendRequest(String fromAccount, boolean pass) {
        System.out.println(fromAccount);
        System.out.println(pass);
        RetrofitManager.create(ApiService.class).addFriend(Constants.SP_USER_DATA.get("userAccid").getAsString(),fromAccount,pass?1:0)
                ...
                .subscribe(new Consumer<ResponseData>() {
                    ...
                    public void accept(@io.reactivex.annotations.NonNull ResponseData res) throws Exception {
                        switch (res.getCode()){
                            case 1:
                                IToastUtils.iToast("操作成功", Toast.LENGTH_SHORT);
                                break;
                            case -1:
                                IToastUtils.iToast("操作失败",Toast.LENGTH_SHORT);
                                break;
                        }
                    }

...
import com.netease.nim.ccsocial_nim.jsbridge.JsBridgeActivity;
import com.netease.nim.ccsocial_nim.main.adapter.SettingsAdapter;
import com.netease.nim.ccsocial_nim.main.model.SettingTemplate;
import com.netease.nim.ccsocial_nim.main.model.SettingType;
...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener, SettingsAdapter.CheckChangeListener {
    ...
    private boolean getIsShowPushNoDetail() {
        ...
        if (localConfig == null) {
            localConfig = DemoCache.getNotificationConfig();
            UserPreferences.setStatusConfig(localConfig);
        }
        // 可能出现服务器和本地不一致，纠正

package com.netease.nim.ccsocial_nim.session;
...
import com.netease.nim.ccsocial_nim.mainTab.fragment.ContactFragment.activity.RobotProfileActivity;
import com.netease.nim.ccsocial_nim.mainTab.fragment.ContactFragment.activity.UserProfileActivity;
...
import com.netease.nim.ccsocial_nim.session.action.AVChatAction;
import com.netease.nim.ccsocial_nim.session.action.AckMessageAction;
import com.netease.nim.ccsocial_nim.session.action.FileAction;
import com.netease.nim.ccsocial_nim.session.action.GuessAction;
import com.netease.nim.ccsocial_nim.session.action.RedPacketAction;
import com.netease.nim.ccsocial_nim.session.action.SnapChatAction;
import com.netease.nim.ccsocial_nim.session.action.TeamAVChatAction;
import com.netease.nim.ccsocial_nim.session.action.TipAction;
import com.netease.nim.ccsocial_nim.session.activity.AckMsgInfoActivity;
import com.netease.nim.ccsocial_nim.session.activity.MessageHistoryActivity;
import com.netease.nim.ccsocial_nim.session.activity.MessageInfoActivity;
import com.netease.nim.ccsocial_nim.session.extension.CustomAttachParser;
import com.netease.nim.ccsocial_nim.session.extension.CustomAttachment;
import com.netease.nim.ccsocial_nim.session.extension.GuessAttachment;
...
import com.netease.nim.ccsocial_nim.session.extension.RedPacketAttachment;
import com.netease.nim.ccsocial_nim.session.extension.RedPacketOpenedAttachment;
import com.netease.nim.ccsocial_nim.session.extension.SnapChatAttachment;
import com.netease.nim.ccsocial_nim.session.extension.StickerAttachment;
import com.netease.nim.ccsocial_nim.session.search.SearchMessageActivity;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderDefCustom;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderFile;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderGuess;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderMultiRetweet;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderNertcCall;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderOpenRedPacket;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderRTS;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderRedPacket;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderSnapChat;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderSticker;
import com.netease.nim.ccsocial_nim.session.viewholder.MsgViewHolderTip;

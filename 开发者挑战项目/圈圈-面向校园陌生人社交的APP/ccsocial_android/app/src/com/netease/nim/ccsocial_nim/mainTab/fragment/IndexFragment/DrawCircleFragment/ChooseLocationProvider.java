...
public class ChooseLocationProvider implements LocationProvider {
    @Override
    public void requestLocation(Context context, Callback callback) {
        ...
        ChooseLocationMapActivity2.start(context, callback);
    }

    @Override
    public void openMap(Context context, double longitude, double latitude, String address) {
        Intent intent = new Intent(context, ChooseLocationMapActivity.class);

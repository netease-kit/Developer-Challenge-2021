...
import com.netease.nim.ccsocial_nim.mainTab.fragment.IndexFragment.MyCircleActivity.PagerSlidingMyCircleTabStrip;
import com.netease.nim.uikit.common.fragment.TabFragment;

public abstract class MyCircleSlidingTabPagerAdapter extends FragmentPagerAdapter implements TabFragment.State,
        PagerSlidingMyCircleTabStrip.OnTabClickListener, PagerSlidingMyCircleTabStrip.OnTabDoubleTapListener {
    ...
    public MyCircleSlidingTabPagerAdapter(FragmentManager fm, int count, Context context, ViewPager pager) {
        super(fm);

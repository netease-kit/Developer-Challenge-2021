...
public class PagerSlidingMyCircleTabStrip extends HorizontalScrollView implements OnPageChangeListener {
    ...
    public PagerSlidingMyCircleTabStrip(Context context) {
        this(context, null);
    }

    public PagerSlidingMyCircleTabStrip(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingMyCircleTabStrip(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void addTabView(final int position, String title) {
        ...
        if (tabView == null) {
            tabView = inflater.inflate(R.layout.tab_layout_my_circle, null);
        }
        ...
        if (titleTV != null) {
            titleTV.setTextSize(TypedValue.COMPLEX_UNIT_PX, needAdaptation ? resources.getDimensionPixelSize(R.dimen.text_size_14) : resources.getDimensionPixelSize(R.dimen.text_size_16));

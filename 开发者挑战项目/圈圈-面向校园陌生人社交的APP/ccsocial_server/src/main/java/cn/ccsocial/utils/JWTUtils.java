...
public class JWTUtils {
     ...
     * 加密秘钥
     */
    private  static final String SECRET = "ccsocial.net168";


    /**
     * 令牌前缀
     */
    private  static final String TOKEN_PREFIX = "ccsocial";
    ...
    public static String geneJsonWebToken(User user){
        ...
        String token = Jwts.builder().setSubject(SUBJECT)
                .claim("user_avatar",user.getUserAvatar())
                .claim("phone",user.getUserPhone())
                .claim("ccid",user.getUserCcid())

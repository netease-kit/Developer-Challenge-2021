...
public class User  {
    ...
    private String userSchoolTimetable;
    ...
    public String getUserSchoolTimetable() {
        return userSchoolTimetable;
    }

    public void setUserSchoolTimetable(String userSchoolTimetable) {
        this.userSchoolTimetable = userSchoolTimetable;
    }
